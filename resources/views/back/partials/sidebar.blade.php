                        ...
                        @can('products.brands')
                            <li class="{{ open_class(['admin.brands.*']) }}">
                                ...
                                <ul class="menu-content">
                                    ...
                                    <li class="{{ active_class('admin.brands.category') }}">
                                        <a class="{{ active_class('admin.brands.category') }}"
                                           href="{{ route('admin.brands.category') }}"><i class="feather icon-circle"></i><span
                                                class="menu-item">دسته بندی های برند</span></a>
                                    </li>
                                </ul>
                            </li>
                        @endcan
